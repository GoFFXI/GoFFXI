...
import (
	...
	"github.com/GoFFXI/GoFFXI/internal/servers/lobby/auth"
)
...
func main() {
	...
	// some house-keeping
	logger.Info("lobby-auth server started", "version", Version, "buildDate", BuildDate, "gitCommit", GitCommit)
	defer cancelCtx()
	...
	if err = authServer.WaitForShutdown(cancelCtx, &wg); err != nil {
